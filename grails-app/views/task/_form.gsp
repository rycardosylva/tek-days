...
<div class="fieldcontain ${hasErrors(bean: taskInstance, field: 'title', 'error')} required">
	<label for="title"> <g:message code="task.title.label" default="Title" /> <span class="required-indicator">*</span>
	</label>
...
<div class="fieldcontain ${hasErrors(bean: taskInstance, field: 'notes', 'error')} ">
	<label for="notes"> <g:message code="task.notes.label" default="Notes" />
...
<div class="fieldcontain ${hasErrors(bean: taskInstance, field: 'assignedTo', 'error')} ">
	<label for="assignedTo"> <g:message code="task.assignedTo.label" default="Assigned To" />
...
<div class="fieldcontain ${hasErrors(bean: taskInstance, field: 'dueDate', 'error')} ">
	<label for="dueDate"> <g:message code="task.dueDate.label" default="Due Date" />
...
<div class="fieldcontain ${hasErrors(bean: taskInstance, field: 'event', 'error')} required">
	<label for="event"> <g:message code="task.event.label" default="Event" /> <span class="required-indicator">*</span>
	</label>
...
<div class="fieldcontain ${hasErrors(bean: taskInstance, field: 'completed', 'error')} ">
	<label for="completed"> <g:message code="task.completed.label" default="Completed" />
	</label>
