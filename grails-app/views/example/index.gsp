		...
		function dashboard(id, fData) {
			...
			function histoGram(fD) {
				...
				var hGsvg = d3.select(id).append("svg").attr("width",
						...
						hGDim.h + hGDim.t + hGDim.b).append("g").attr(
						"transform",
			...
			function legend(lD) {
				...
				var legend = d3.select(id).append("table").attr('class',
						'legend');
				...
				tr.append("td").append("svg").attr("width", '16').attr(
						"height", '16').append("rect").attr("width", '16')
						.attr("height", '16').attr("fill", function(d) {
